...
#define INV_LOG2_E_Q1DOT7  UINT16_C(0x58)
#define INV_LOG2_E_Q1DOT15  UINT32_C(0x58b9)
#define INV_LOG2_E_Q1DOT31  UINT64_C(0x58b90bfc)

// Inverse log base 2 of 10
#define INV_LOG2_10_Q1DOT7 UINT16_C(0x26)
#define INV_LOG2_10_Q1DOT15 UINT32_C(0x2688)
...
inline uint8_t GetSignF16(Float16* p_Value)
{
	return (p_Value->extExponent & 0x40);
}

inline int8_t GetExponentF16(Float16* p_Value)
{
