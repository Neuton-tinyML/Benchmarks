...
#define NEUTON_MODEL_EXTRACTED_FEATURES_COUNT 3
...
static const uint16_t modelExtractedFeaturesStartIdxForAxle[] = { 0, 1, 2 };
static const uint16_t modelExtractedFeaturesCountForAxle[] = { 1, 1, 1 };
